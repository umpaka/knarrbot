...
# Prompt constants live in their own module — edit system_prompt.py to change agent behaviour.
from system_prompt import _DEFAULT_PERSONALITY, _DEFAULT_INSTRUCTIONS, _TOOL_DOCS  # noqa: E402
